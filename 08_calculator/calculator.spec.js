...
describe('power', () => {
  test('raises one number to the power of 0', () => {
    expect(calculator.power(4, 0)).toBe(1); // 4 to third power is 64
  });
});

describe('power', () => {
  test('raises one number to the power of a negative number', () => {
    expect(calculator.power(4, -2)).toBe(0.0625); // 4 to third power is 64
  });
});
